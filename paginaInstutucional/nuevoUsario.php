...
$consultarUsuarios = "INSERT INTO `tblusurs` (`use_rol_id`,`use_fir_nam`, `use_las_nam`, `use_use`, `use_pas`, `use_ema`) VALUES ('$idRol','$bdNombre','$bdApellido','$bdUsuario','$bdContrasena','$bdCorreo')";
